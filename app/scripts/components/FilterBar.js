...
class FilterBar extends React.Component {
  ...
  _handleRadioChange() {
    this.state.filters.orderType = $('input[name=orderType]:checked')[0].value;
  ...
  _handleReset() {
    ...
    $('input[name=orderType]').parent().removeClass( "active" );
    this.refs['paymentType'].getDOMNode().selectedIndex =0;
    this.props.onReset();
  }
                            ...
                            <label className="control-label">
                                ...
                                <div className="btn-group" data-toggle="buttons">
                                    <label className="btn btn-default" onClick={this._handleRadioChange}>
                                        <input type="radio" name="orderType" ref="orderType" autoComplete="off" value='DINEIN' onChange={this._handleRadioChange}/>DINEIN
                                    </label>
                                    <label className="btn btn-default" onClick={this._handleRadioChange}>
                                        <input type="radio" name="orderType" ref="orderType" autoComplete="off" value='TAKEOUT' onChange={this._handleRadioChange}/>TAKEOUT
                                    </label>
                                </div>
                            </label>
                        </div>
